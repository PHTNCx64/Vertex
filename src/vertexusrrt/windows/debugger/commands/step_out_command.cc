...
namespace debugger
{
    DWORD process_step_out_command(const DebugLoopContext& ctx, const DWORD threadId, const bool isWow64)
    {
        const auto stepOutTarget = get_step_out_target(threadId, isWow64);
